...
export default function Home() {
  return (
    <>
      <img className="absolute top-1/2 left-1/2 translate-x-[-50%] translate-y-[-50%] hidden lg:block xl:w-96 lg:w-48 z-0"  src={'/vader.png'} width={400} height={400} alt='bg-vader'/>
